...
function ForecastHourlyReport() {
  const [reportType, setReportType] = useState('hourly-a');
  ...
  return (
    ...
    >
      <div className="mt-5 flex justify-start gap-40">
        <Radio
          label=" pic"
          name="hourly-reportType"
          value="hourly-a"
          checked={reportType === 'hourly-a'}
...
export default ForecastHourlyReport;