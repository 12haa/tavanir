...
function LoginModal({ children }: { children?: ReactNode }) {
  return (
    <div className="relative w-[400px] h-[587px] rounded-2xl bg-white/40 shadow-xl backdrop-blur-md px-4">
      ...
      <div className="pt-[40px] flex flex-col items-center justify-center h-full">{children}</div>
    </div>
  );
}
